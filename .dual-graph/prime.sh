#!/usr/bin/env bash
PORT=$(cat "/Users/marczider/Source/Jyra/.dual-graph/mcp_port" 2>/dev/null || echo 8080)
...
if [[ -f "/Users/marczider/Source/Jyra/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/Users/marczider/Source/Jyra/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject context store entries (decisions, tasks, next steps) — max 15 lines, 7-day window
STORE="/Users/marczider/Source/Jyra/.dual-graph/context-store.json"
